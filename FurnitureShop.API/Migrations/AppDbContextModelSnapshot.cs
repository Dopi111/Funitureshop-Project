...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.ChatConversation", b =>
                {
                    ...
                    b.Property<string>("ConversationNumber")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.SupportReply", b =>
                {
                    b.Property<int>("SupportReplyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SupportReplyId"));
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.SupportTicket", b =>
                {
                    b.Property<int>("SupportTicketId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.ChatMessage", b =>
                {
                    b.HasOne("FurnitureShop.API.Models.Entities.ChatConversation", "ChatConversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("FurnitureShop.API.Models.Entities.SupportReply", b =>
                {
                    b.HasOne("FurnitureShop.API.Models.Entities.SupportTicket", "SupportTicket")
                        .WithMany("Replies")
