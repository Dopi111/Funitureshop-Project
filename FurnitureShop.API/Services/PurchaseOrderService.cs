...
namespace FurnitureShop.API.Services
{
    public interface IPurchaseOrderService
    {
        ...
        Task<SupplierDto?> UpdateSupplierAsync(int id, CreateSupplierDto dto, bool isActive);
    ...
    public class PurchaseOrderService : IPurchaseOrderService
    {
        ...
        public async Task<SupplierDto?> UpdateSupplierAsync(int id, CreateSupplierDto dto, bool isActive)
        {
        ...
        public async Task<bool> DeleteSupplierAsync(int id)
        {
            ...
            // Keep purchase order history intact; "delete" means deactivate.
        ...
        public async Task<bool> CompletePurchaseOrderAsync(int poId)
        {
            ...
            foreach (var detail in po.Details)
            {
                ...
                if (product != null)
                {
                    var existingQuantity = Math.Max(product.StockQuantity, 0);
                    var existingValue = (product.CostPrice ?? detail.UnitPrice) * existingQuantity;
                    product.CostPrice = existingQuantity + detail.Quantity > 0
                        ? (existingValue + detail.UnitPrice * detail.Quantity) / (existingQuantity + detail.Quantity)
                        : detail.UnitPrice;
